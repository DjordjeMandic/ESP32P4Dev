...
void app_main(void)
{
    ESP_LOGI(TAG, "Starting eMMC example");
    esp_err_t ret;

    ESP_LOGI(TAG, "Enabling LDO channel 4 at 1.8V");
    ...
    ESP_LOGI(TAG, "LDO channel 4 enabled at 1.8V");
    ...
    ESP_LOGI(TAG, "LDO channel 4 released");
}
